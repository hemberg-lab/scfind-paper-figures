...
pmid2variant, uniquePMIDsVariants, allVariants = buildPMID2mutationMap()
...
variant2genename_hs_filter, variant2genename_hs_count_filter = filterMap(variant2genename_hs, variant2genename_hs_count, minCount=1);
saveMapFile("~/variant2genename_hs_filter.tsv", variant2genename_hs_filter, variant2genename_hs_count_filter);
